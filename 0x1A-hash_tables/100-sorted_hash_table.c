 ...
 *
 * Description: adds a node at the begining of a shash
 *		at a given index
 *
 * Return: created node
 */
...
/**
 * shash_table_set - func
 * @ht: pointer to the shash table
 * @key: key of the shash
 * @value: value to store
 *
 * Description: adds a hash to a given shash table
 *
...
/**
 * shash_table_print - func
 * @ht: pointer to the shash table
 *
 * Description: prints the keys and values of shash table
 *
 * Return: 0
 */
...
/**
 * shash_table_print_rev -func
 * @ht: pointer to the shash table
 *
 * Description: prints the keys and value of shash table
 *		in reverse
 *
 * Return: 0
 */
